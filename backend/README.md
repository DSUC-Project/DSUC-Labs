...
Academy learner progress/stats need JWT. Curated content seed (edit only): `content/academy-v2/seed/` — see `content/academy-v2/README.md`. Frontend loads the same files via `@academy-v2-seed` (no second copy, no sync step).
